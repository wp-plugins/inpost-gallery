...
//***
    ...
    <?php if(!empty($slides)): ?>
        ...
        <?php foreach($slides as $gallery_item) : ?>
            ...
            ?>
            <a target="_blank" data-postid='fsg_group_<?php echo $unique_id ?>' data-imgid='<?php echo ($counter++) ?>' href='<?php echo $slide_url ?>'><img src="<?php echo $thumb_url ?>" style="<?php echo $styles_img ?>" alt="" /></a>
        <?php endforeach; ?>
