...
<div id="pn_shortcode_template" class="pn_shortcode_template clearfix">
    ...
    <div class="one-half">
        ...
        PluginusNet_InpostGallery::draw_shortcode_option(array(
            ...
            'id' => '',
            'default_value' => PluginusNet_InpostGallery::set_default_value('thumb_width', 200),
            'description' => ''
        ));
        ?>
    ...
    <div class="one-half">
        ...
        PluginusNet_InpostGallery::draw_shortcode_option(array(
            ...
            'id' => '',
            'default_value' => PluginusNet_InpostGallery::set_default_value('thumb_height', 200),
            'description' => ''
        ));
        ?>
    ...
    <div class="one-half">
        ...
        PluginusNet_InpostGallery::draw_shortcode_option(array(
            ...
            'id' => '',
            'default_value' => PluginusNet_InpostGallery::set_default_value('js_play_delay', 3000),
    ...
    <div style="display: none;">
        ...
        PluginusNet_InpostGallery::draw_shortcode_option(array(
            'type' => 'text',
            'title' => __('post_id', 'inpost-gallery'),
