...
<input type="text" value="[inpost_gallery post_id=<?php echo $post_id ?>] OR [inpost_gallery post_id=<?php echo $post_id ?> random=-1]" readonly="" style="width: 99%;" /><br />
<br />
<a href="#" class="js_inpost_gallery_add_slide inpost_gallery_add_slide_button"><?php _e("Add slide", 'inpost-gallery') ?></a><br />
