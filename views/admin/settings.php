        ...
        <div style="width: 60%">
            <form action="/" method="post" id="inpost_gallery_settings_form">
                ...
                <div class="form-field">
                    <label style="display: inline-block" for="not_use_timthumb"><?php _e("Don`t use timthumb", 'inpost-gallery') ?>:</label>&nbsp;<input style="width: auto !important;" class="inpost_gallery_checkbox_selfupdated" type="checkbox" name="not_use_timthumb" <?php if ($not_use_timthumb): ?>checked=""<?php endif; ?> value="<?php echo $not_use_timthumb ?>" />
