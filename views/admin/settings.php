    ...
    <div class="form-wrap">
        ...
        <div style="width: 60%">
            <form action="/" method="post" id="inpost_gallery_settings_form">
                ...
                <div class="form-field" id="wordpress_custom_sizes">
                    <b><?php _e("YoxView default thumbnail size", 'inpost-gallery') ?></b>:&nbsp;<input class="inpost_gallery_image_size_field" type="text" value="<?php echo $thumb_default_width ?>" name="thumb_default_width" />&nbsp;x&nbsp;<input class="inpost_gallery_image_size_field" type="text" value="<?php echo $thumb_default_height ?>" name="thumb_default_height" />&nbsp;px<br />
                </div>
            ...
            <br />
            <h3><?php _e("Want to get power and amazing WordPress theme?!", 'inpost-gallery') ?></h3>
