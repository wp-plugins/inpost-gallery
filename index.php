...
/*
  ...
  Description: Gallery in post and page simply
...
//add_action('wp_head', array('PluginusNet_InpostGallery', 'wp_head'), 999, 1);
...
class PluginusNet_InpostGallery {
	...
	public static function wp_head() {
		?>
		<style type="text/css">
		<?php echo self::$settings['inpost_gallery_css_styles'] ?>
		</style>
		<?php
	}
	...
	public static function admin_init() {
		add_meta_box("inpost_gallery_meta_box", __("InPost Gallery", 'inpost-gallery'), array(__CLASS__, 'draw_post_panel'), "page", "normal", "default");
		add_meta_box("inpost_gallery_meta_box", __("InPost Gallery", 'inpost-gallery'), array(__CLASS__, 'draw_post_panel'), "post", "normal", "default");
	}
