...
all you need it is popup with shortcode options in your current page editor.
...
= 2.0.5 =
Added special expressions for selecting output images, Read more here: http://pluginus.net/inpost-gallery-2-0-5-release .
